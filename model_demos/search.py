...
if __name__ == "__main__":
    ...
    #summary = ws.askInternet_google("News headlines today")
    print("\n\nDDGS ALL SUMMARIES:\n\n")
    print(summary,"\n\n",len(summary))
    ...
    summary2 = ws.askInternet_google("News headlines today")
    print("\n\nGOOGLE ALL SUMMARIES:\n\n")
    print(summary2,"\n\n",len(summary2))

    xz = ws.summarize_text("".join(summary2))
    print("\n\nSUMMARY OF ALL SUMMARIES:\n\n")
    print(xz)