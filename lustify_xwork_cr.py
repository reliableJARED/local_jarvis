...
if __name__ == "__main__":
    ...
    def photoshoot(combos,style,lighting,subject,skin,hair,face,eyes,attribute,lips,chest,pose,action,framing,clothes,shoot_folder="demo_shoot",name="demo"):
        """
    ...
    def Rhea(xshoot_name):
        ...
        os.makedirs(f"{directory}/{xshoot_name}", exist_ok=True)
        #os.makedirs(f"{directory}/athena", exist_ok=True)
        #os.makedirs(f"{directory}/zeus", exist_ok=True)
        #os.makedirs(f"{directory}/hera", exist_ok=True)
        #os.makedirs(f"{directory}/dionysus", exist_ok=True)
        ...
        dionysus(subject,skin,hair,face,eyes,attribute,lips,chest,name=name,fabric="yellow")
        apollo(subject,skin,hair,face,eyes,attribute,lips,chest,name=name,fabric="white")
        athena(subject,skin,hair,face,eyes,attribute,lips,chest,name=name,fabric="white")
        zeus(subject,skin,hair,face,eyes,attribute,lips,chest,name=name,fabric="red")
        hera(subject,skin,hair,face,eyes,attribute,lips,chest,name=name,fabric="white")
        

    #Photoshoot Aphrodite:
    def Aphrodite(xshoot_name):
        name = "aphrodite"
        directory = name
        os.makedirs(directory, exist_ok=True)
        os.makedirs(f"{directory}/{xshoot_name}", exist_ok=True)  
        """os.makedirs(f"{directory}/apollo", exist_ok=True)
        os.makedirs(f"{directory}/athena", exist_ok=True)
        os.makedirs(f"{directory}/zeus", exist_ok=True)
        os.makedirs(f"{directory}/hera", exist_ok=True)
        os.makedirs(f"{directory}/dionysus", exist_ok=True)"""
        ...
        dionysus(subject,skin,hair,face,eyes,attribute,lips,chest,name=name,fabric="black")
        apollo(subject,skin,hair,face,eyes,attribute,lips,chest,name=name,fabric="pink")
        athena(subject,skin,hair,face,eyes,attribute,lips,chest,name=name,fabric="pink")
        zeus(subject,skin,hair,face,eyes,attribute,lips,chest,name=name,fabric="white")
        hera(subject,skin,hair,face,eyes,attribute,lips,chest,name=name,fabric="white")
        
    
    #Photoshoot Eros:
    def Eros(xshoot_name):
        name ="eros"
        directory = name
        os.makedirs(directory, exist_ok=True)  
        os.makedirs(f"{directory}/{xshoot_name}", exist_ok=True)
        ...
        dionysus(subject,skin,hair,face,eyes,attribute,lips,chest,name=name,fabric="red")
        apollo(subject,skin,hair,face,eyes,attribute,lips,chest,name=name,fabric="white")
        athena(subject,skin,hair,face,eyes,attribute,lips,chest,name=name,fabric="white")
        zeus(subject,skin,hair,face,eyes,attribute,lips,chest,name=name,fabric="black")
        hera(subject,skin,hair,face,eyes,attribute,lips,chest,name=name,fabric="black")
        
    
    #Photoshoot Demetra DONE:
    def Demetra(xshoot_name):
        """
        DONE
        """
        ...
        dionysus(subject,skin,hair,face,eyes,attribute,lips,chest,name=name,fabric="pink")
        apollo(subject,skin,hair,face,eyes,attribute,lips,chest,name=name)
        athena(subject,skin,hair,face,eyes,attribute,lips,chest,name=name)
        zeus(subject,skin,hair,face,eyes,attribute,lips,chest,name=name)
        hera(subject,skin,hair,face,eyes,attribute,lips,chest,name=name)
        

    #Photoshoot Hesperus:
    def Hesperus(xshoot_name):
        """ DONE """
        name ="hesperus"
        directory = name
        os.makedirs(directory, exist_ok=True)
        ...
        dionysus(subject,skin,hair,face,eyes,attribute,lips,chest,name=name,fabric="white")
        apollo(subject,skin,hair,face,eyes,attribute,lips,chest,name=name,fabric="green")
        athena(subject,skin,hair,face,eyes,attribute,lips,chest,name=name,fabric="green")
        zeus(subject,skin,hair,face,eyes,attribute,lips,chest,name=name,fabric="light blue")
        hera(subject,skin,hair,face,eyes,attribute,lips,chest,name=name,fabric="tartan")
        

    def Ares(xshoot_name):
        """ DONE """
        name ="ares"
        directory = name
        os.makedirs(directory, exist_ok=True)
    ...
    def photographModel(xmodel,xshoot,fabric=None):
        #get string name of the shoot 
        xshoot_name = xshoot.__name__
        #get the model attributes
        subject,skin,hair,face,eyes,attribute,lips,chest, name = xmodel(xshoot_name)
